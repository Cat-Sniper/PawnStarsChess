...
ChessPiece::ChessPiece(int playerID, glm::mat4 rsMat) : _targetShader("vertex.vert", "fragment.frag") {
	_playerID = playerID;
...
std::vector<glm::ivec2> ChessPiece::getMoves(glm::ivec2 current, int xLimit, int yLimit) { return {}; }